...
1. Add your API method to `src/main/java/edu/utexas/amlweems/blog/YourFirstAPI.java`.

1. Optional step: These sub steps are not required but you need this
   if you want to have auth protected methods.

    1. Update the values in `src/main/java/edu/utexas/amlweems/blog/Constants.java`
